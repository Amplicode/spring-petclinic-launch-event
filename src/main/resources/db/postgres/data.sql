...
INSERT INTO vet_specialties(id, vet_id, specialty_id) SELECT 1, 2, id FROM specialties WHERE name='radiology' and NOT EXISTS (SELECT * FROM vet_specialties WHERE id=1);
INSERT INTO vet_specialties(id, vet_id, specialty_id) SELECT 2, 3, id FROM specialties WHERE name='surgery' and NOT EXISTS (SELECT * FROM vet_specialties WHERE id=2);
INSERT INTO vet_specialties(id, vet_id, specialty_id) SELECT 3, 3, id FROM specialties WHERE name='dentistry' and NOT EXISTS (SELECT * FROM vet_specialties WHERE id=3);
INSERT INTO vet_specialties(id, vet_id, specialty_id) SELECT 4, 4, id FROM specialties WHERE name='surgery' and NOT EXISTS (SELECT * FROM vet_specialties WHERE id=4);
INSERT INTO vet_specialties(id, vet_id, specialty_id) SELECT 5, 5, id FROM specialties WHERE name='radiology' and NOT EXISTS (SELECT * FROM vet_specialties WHERE id=5);
